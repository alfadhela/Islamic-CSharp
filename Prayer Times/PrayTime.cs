...
namespace org.tamrah.islamic.Pray
{
	...
	{
		org.tamrah.islamic.hijri.Calendar calendar;
     ...
     */
		...
		public PrayTime ()
		{
			...
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Jafari]	=new double []{16, 0, 4, 0, 14};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Karachi]	= new double [] {18, 1, 0, 0, 18};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.ISNA] 	= new double [] {15, 1, 0, 0, 15};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.MWL]		= new double [] {18, 1, 0, 0, 17};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Makkah]	= new double [] {18.5, 1, 0, 1, 90};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Egypt]	= new double [] {19.5, 1, 0, 0, 17.5};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Tehran]	= new double [] {17.7, 0, 4.5, 0, 14};
			this.methodParams[org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM.Custom]	= new double [] {18, 1, 0, 0, 17};
		}
		...
		public PrayTime(org.tamrah.islamic.hijri.Calendar date, double latitude,
		                double longitude, int timeZone, 
		                org.tamrah.islamic.pray.CalculationMethod.CalculationMethodM calculationMethod,
		                org.tamrah.islamic.pray.JuristicMethod.JuristicMethodM juristicMethods){
			this.calendar = date;
			this.lat = latitude;
			this.lng = longitude;
			this.timeZone = timeZone;
			this.calcMethod =Convert.ToInt32(calculationMethod);
			this.asrJuristic =Convert.ToInt32(juristicMethods);
			init();
		}
		private void init(){
			// Initialize vars
